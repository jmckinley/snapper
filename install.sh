...
echo "    3. Configure notifications: Telegram (docs/TELEGRAM_SETUP.md)"
echo "       or Slack (docs/SLACK_SETUP.md)"
echo "    4. Store PII via Telegram or Slack: /vault add \"My Card\" credit_card"
