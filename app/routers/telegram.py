    ...
    if text.startswith("/start"):
        ...
        await _send_message(
            ...
            text=(
                ...
                "*Rules:*\n"
                "/rules - View active security rules\n"
                "/test run `<cmd>` - Test if command allowed\n\n"
                "*PII Vault:*\n"
                "/vault list - View your entries\n"
                "/vault add `<label>` `<type>` - Add entry\n"
                "  Types: `cc`, `name`, `addr`, `phone`,\n"
                "  `email`, `ssn`, `passport`, `bank`, `custom`\n"
                "/vault delete `<token>` - Delete one entry\n"
                "/vault delete \\* - Delete all (with confirm)\n"
