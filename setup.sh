...
echo -e "  security profile selection, and notification setup (Telegram/Slack)."
echo ""
...
echo "    This is a dev environment with relaxed defaults:"
echo "      - LEARNING_MODE=true   (violations logged, not blocked)"
echo "      - Postgres/Redis ports exposed to localhost"
echo ""
echo "    For production (VPS/cloud), use ./deploy.sh instead:"
echo "      ./deploy.sh                              # IP + self-signed TLS"
echo "      ./deploy.sh --domain snapper.example.com # auto Let's Encrypt"
echo ""
echo "    Run anytime:  python scripts/snapper-cli.py security-check"
echo ""
