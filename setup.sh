...
echo "    This is a dev environment (learning mode, no TLS)."
echo "    For production, use ./deploy.sh which adds TLS, firewall,"
echo "    and runs a security posture assessment."
echo ""
